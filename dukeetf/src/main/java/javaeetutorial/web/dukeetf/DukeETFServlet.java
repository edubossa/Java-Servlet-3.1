...
/**
 * O dukeetf aplicação exemplo, demonstra como usar o processamento assíncrono em um servlet para fornecer atualizações de 
 * dados para clientes web. O exemplo se assemelha a um serviço que fornece atualizações 
 * periodicas sobre o preco e volume de negociacao de um fundo negociado eletronicamente (ETF)
 * 
 * <p>
...
public class DukeETFServlet extends HttpServlet {
	private static final long serialVersionUID = 5158300061427990318L;
